...
class RegisterCategoriesCommandsProvider {
  public async execute(): Promise<void> {
    ...
    try {
      ...
      const categoryRunnerCommand = new CustomCategoryRunner(
        guildEnabledCategories,
        commandoClient,
        {
          name: '@categories',
      ...
      log.debug(
        '[RegisterCategoriesCommandsProvider] custom categories registered: ',
        aliases,
      );
      log.info(
  ...
  unloadCategoriesIfAlreadyRegistered(
